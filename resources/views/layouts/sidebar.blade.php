<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li> <a href="{{ route('category.view') }}"><i class='bx bx-radio-circle'></i>Create Category</a>
						</li>
						<li> <a href="{{ route('category.show') }}"><i class='bx bx-radio-circle'></i>View Category</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						<li> <a href="{{ route('product.view') }}"><i class='bx bx-radio-circle'></i>Create Product</a>
						</li>
						<li> <a href="{{ route('product.show') }}"><i class='bx bx-radio-circle'></i>View Product</a>
						</li>
					</ul>
				</li>
				<li>
